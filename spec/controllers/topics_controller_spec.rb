...
#this is assignment 40
  context "moderator user" do
    ...
    # can see all posts and edit but not create or delete
    # posts: index, show, edit, update (not new, create, or destroy)
    # view: index, show like member
    # edit, update like admin
    # can see all topics and edit but not create or delete
    # topics: index, show, edit, update (not new, create, or destroy)
